    ...
    def _executar_envio(
        ...
        def _thread():
            ...
            try:
                ...
                _PREFETCH_WINDOW = 15  # Quantidade de faturas seguintes preparadas antecipadamente (forma um "estoque" de PDFs prontos para envio imediato)
                _PREFETCH_WORKERS = 5 # Quantidade de downloads simultâneos no Waterfy em segundo plano (cuidado com valores altos para evitar bloqueio por excesso de acessos)
